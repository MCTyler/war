...
public final class PropertiesFile {
	...
	public PropertiesFile(String fileName) {
		...
		try {
			...
			PropertiesFile.log.log(Level.SEVERE, "[PropertiesFile] Unable to load {0}!", fileName);
		}
	}
	...
	public void save() {
		try {
			...
			PropertiesFile.log.log(Level.SEVERE, "[PropertiesFile] Unable to save {0}!", this.fileName);
		}
	}
	...
	public void close() {
		if (this.outputStream != null) {
			try {
				...
				PropertiesFile.log.log(Level.SEVERE, "[PropertiesFile] Failed to close {0} writer!", this.fileName);
			}
		} else if (this.inputStream != null) {
			try {
				this.inputStream.close();
			} catch (IOException e) {
				PropertiesFile.log.log(Level.SEVERE, "[PropertiesFile] Failed to close {0} reader!", this.fileName);
			}
		}
	}
